...
class UserSeeder extends Seeder
{
    ...
    {
        $data = [
            ['name' => 'Lumi Novry M', 'email' => 'lumi@gmail.com', 'email_verified_at' => null, 'role' => 'administrator' ,'password' => Hash::make('Mysql@2023'), 'remember_token' => null, 'created_at' => date(now()), 'updated_at' => null]
        ];
